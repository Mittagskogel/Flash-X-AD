...
MPI_PATH   = /apps/openmpi/gnu/9.1/4.0.3-hpcx
HDF4_PATH  =
HDF5_PATH  = /apps/hdf5/gnu/9.1/openmpi/4.0/1.12.0
...
NCMPI_PATH = /apps/netcdf/gnu/9.1/openmpi/4.0/4.7.4
MPE_PATH   =
...
FCOMP   = ${MPI_PATH}/bin/mpif90  # ${HDF5_PATH}/bin/h5pfc
CCOMP   = ${MPI_PATH}/bin/mpicc # ${HDF5_PATH}/bin/h5pcc
CPPCOMP = ${MPI_PATH}/bin/mpicxx
LINK    = ${MPI_PATH}/bin/mpif90  #${HDF5_PATH}/bin/h5pfc
