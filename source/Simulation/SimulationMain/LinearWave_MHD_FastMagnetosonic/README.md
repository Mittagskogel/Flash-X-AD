# Fast Magnetosonic wave problem.
...
```
./setup LinearWave_MHD_FastMagnetosonic -auto -1d -maxblocks=100 -nxb=${nX} -site=<site> +hdf5 +cartesian +spark useGLM=true +nofbs useTVD=true -parfile=flash_${nX}.par
```
...
ifinal = 0001.
	...
	5) probName = name of data, e.g., 'linWave_MHD_FM' -> must match basenm parameter in par file 
