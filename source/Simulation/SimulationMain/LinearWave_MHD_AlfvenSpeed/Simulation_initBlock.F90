!!****if* source/Simulation/SimulationMain/LinearWave_MHD_AlfvenSpeed/Simulation_initBlock
!! NOTICE
  ...
  do k = lo(KAXIS), hi(KAXIS)
     ...
     do j = lo(JAXIS), hi(JAXIS)
        ...
        do i = lo(IAXIS), hi(IAXIS)
           ...
           ! the Alfven wave mode.
           R_eig_1 = 0.
           R_eig_2 = 0.
           R_eig_3 = SIGN(1., sim_Direction) * Beta_z
           R_eig_4 = SIGN(1., sim_Direction) * -1. * Beta_y
           R_eig_5 = 0.
           R_eig_6 = -1. * Beta_z * sqrt(sim_rho) * SIGN(1., sim_Bx) 
           R_eig_7 = Beta_y * sqrt(sim_rho) * SIGN(1., sim_Bx)
