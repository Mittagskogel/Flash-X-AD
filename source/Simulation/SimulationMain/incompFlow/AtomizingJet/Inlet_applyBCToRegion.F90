!!***if* source/Simulation/SimulationMain/incompFlow/CrossFlow/Inlet_applyBCToRegion
!!
!!
!! NOTICE
...
subroutine Inlet_applyBCToRegion(level, ivar, gridDataStruct, regionData, coordinates, regionSize, &
   ...
   use Simulation_data, ONLY: sim_jetCoords, sim_jetRadius, sim_jetVel, sim_jetAmp, sim_jetFreq
