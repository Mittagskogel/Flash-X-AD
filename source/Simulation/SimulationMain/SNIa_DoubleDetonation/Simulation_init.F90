...
#include "Eos.h"
  ...
  real :: mass, dmass, volc, vole, dvol, r1, r2, dr
  ...
  call RuntimeParameters_get('xc12_match', sim_xc12Match)
  call RuntimeParameters_get('xo16_match', sim_xo16Match)
  call RuntimeParameters_get('xni56_match', sim_xni56Match)
  ...
  sim_wd_mass_tab(sim_wd_npnts+1) = sim_wd_mass_tab(sim_wd_npnts) + &
                                    sim_wd_dens_tab(sim_wd_npnts+1) * &
