!!****f* source/Simulation/SimulationMain/SNIa_DoubleDetonation/Simulation_wantsRebalance
!! NOTICE
...
!!
!!  For SNIa_DoubleDetonation, the load imbalance is very severe
!!  and expensive, so redistribute every timestep.
!!
!! ARGUMENTS
!!   nstep : current step
!!   time : current time
...
logical function Simulation_wantsRebalance(nstep,time)
  ...
  Simulation_wantsRebalance = .TRUE.
