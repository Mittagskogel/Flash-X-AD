...
!!$  integer :: fileToCurrentMap(NPART_PROPS)
  ...
  if(globalNumParticles > 0 ) then
     ...
     ! call Particles_copyToMeshOwned for initializing amrex 
#ifdef FLASH_GRID_AMREX
     call Particles_copyToMeshOwned(particles(:,1:reLocalNumParticles), fileNumPartProps, reLocalNumParticles, filePropNames)
#endif   
