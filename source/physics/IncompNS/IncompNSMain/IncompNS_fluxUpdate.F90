!!****if* source/physics/IncompNS/IncompNSMain/IncompNS_fluxUpdate
!! NOTICE
...
!----------------------------------------------------------------------------------------
   ...
   call Timers_start("IncompNS_fluxUpdate")
   ...
   facexData(VELC_FACE_VAR, lo(1):hi(1)+1, lo(2):hi(2), lo(3):hi(3)) = fluxxData(VELC_FLUX, :, :, :)
   faceyData(VELC_FACE_VAR, lo(1):hi(1), lo(2):hi(2)+1, lo(3):hi(3)) = fluxyData(VELC_FLUX, :, :, :)

   facexData(PGN1_FACE_VAR, lo(1):hi(1)+1, lo(2):hi(2), lo(3):hi(3)) = fluxxData(PRES_FLUX, :, :, :)
   faceyData(PGN1_FACE_VAR, lo(1):hi(1), lo(2):hi(2)+1, lo(3):hi(3)) = fluxyData(PRES_FLUX, :, :, :)
#if NDIM==3
   facezData(VELC_FACE_VAR, lo(1):hi(1), lo(2):hi(2), lo(3):hi(3)+1) = fluxzData(VELC_FLUX, :, :, :)
   facezData(PGN1_FACE_VAR, lo(1):hi(1), lo(2):hi(2), lo(3):hi(3)+1) = fluxzData(PRES_FLUX, :, :, :)
#endif      
   ...
   call Timers_stop("IncompNS_fluxUpdate")
